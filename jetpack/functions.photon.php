...
function jetpack_photon_url( $image_url, $args = array(), $scheme = null ) {
	...
	if ( in_array( $image_url_parts['host'], array( 's.wjn.me' ) ) ) {
	...
	$phton_url = jetpack_photon_url_scheme( $photon_url, $scheme );
	return apply_filters('jetpack_photon_url', $photon_url, $image_url, $args, $scheme);
}
